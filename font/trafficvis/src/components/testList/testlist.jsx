  ...
  return (
    <>
      <Row style={{ width: "100%", height: "100%" }}>
        <Col span={8} id="ListLeft">
        <div id = 'totalList'  style={{ height: "50%" }} >

        </div>
        <div id = 'totalID' style={{ height: "50%" }} >

        </div>

        </Col>
        <Col span={16} id="ListRight">
          {/*该时间段内所有高价值场景列表 */}
        <div id = 'listContainer' style={{ height: "50%" }}  >
        {/* <ListContainer></ListContainer> */}
        </div>

        <div id = 'listID' style={{ height: "50%" }} >
        {/* <ListID></ListID> */}
        </div>
        </Col>
